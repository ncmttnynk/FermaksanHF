...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH_Sag" runat="Server">
    <asp:UpdatePanel ID="up" runat="server">
       <Triggers>
        ...
        <ContentTemplate>
            <div class="modal fade show" id="pnlKayitlar" tabindex="-1" role="dialog" style="display: block; padding-right: 17px; overflow: scroll;" runat="server" visible="false">
                <div class="modal-dialog">
                    <div class="modal-content pb-3" style="width: 650px !important; margin-left: -40px !important; height: auto;">
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <asp:Literal ID="ltlModalBaslik" runat="server" /></h4>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="alert alert-info alert-sm">
                        <strong>Dikkat!</strong> Yüksekliği 500 olan fotoğraf eklemeniz tavsiye edilir.
                    </div>
                </div>
            </div>
