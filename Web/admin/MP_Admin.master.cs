...
public partial class admin_MP_Admin : IMP_Main
{
    ...
    protected int DilKod
    {
        get
        {
            ...
            else if (Session["Dil"].ToString() == "en") return 2;
            return 1;
        }
    }
    string AdminAdSoyad
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ltlMenuDil.Text = (DilKod == 1) ? @"<a class=""dropdown-item"" href=""/Language.aspx?Dil=en&Url=%2fadmin%2fAnasayfa.aspx"">
    ...
    protected void btnCikisYap_Click(object sender, EventArgs e)
    {
        ...
        Session.Abandon();
        Response.Redirect("/" + Dil + "/Default.aspx", true);
    }
