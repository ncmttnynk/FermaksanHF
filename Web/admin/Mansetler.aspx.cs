...
public partial class admin_Slider : IPage
{
        ...
        mp.Buradasiniz = new List<Info.BuradasinizInfo>
                {
                    ...
                    new Info.BuradasinizInfo {Title="Manşetler"}
                };
    ...
    protected void btnYeni_Click(object sender, EventArgs e)
    {
        ...
        txtMansetUrl.Text = "";
        imgSlider.ImageUrl = "";
        ltlModalBaslik.Text = "Yeni Manşet Ekle";
    }
    ...
    protected void gvKayitlar_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            var kayit = e.Row.DataItem as Info.MansetlerInfo;
