<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MP_Admin.master" AutoEventWireup="true" CodeFile="ServisTalepleri.aspx.cs" Inherits="admin_ServisTalepleri" %>
        ...
        <ContentTemplate>
                    ...
                    <div class="modal-content" style="height: auto;">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <blockquote class="blockquote-primary">
                                        <asp:Literal ID="ltlServisTelefon" runat="server" />
                                    </blockquote>
                                </div>
                            </div>
                            <div class="row">
            ...
            <asp:GridView ID="gvKayitlar" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered" GridLines="None" OnRowCommand="gvKayitlar_RowCommand" OnRowDataBound="gvKayitlar_RowDataBound">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Telefon" DataField="Telefon" HeaderStyle-CssClass="center" ItemStyle-CssClass="center" HeaderStyle-Width="200" />
